...
SRC = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_strlen.c\
	  ...
	  ft_putnbr_fd.c ft_printf.c ft_putnbr_base.c ft_printf_util1.c ft_printf_util2.c
...
OBJS = ft_isalpha.o ft_isdigit.o ft_isalnum.o ft_isascii.o ft_isprint.o ft_strlen.o\
	   ...
	   ft_putnbr_fd.o ft_printf.o ft_putnbr_base.o ft_printf_util1.o ft_printf_util2.o
